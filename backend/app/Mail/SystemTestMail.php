...
class SystemTestMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'MyLMS: Institutional Communication Test Protocol',
        );
    }
            ...
            htmlString: '
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
                    ...
                    <div style="padding: 40px; line-height: 1.6; color: #1e1b4b;">
                        <p>This is an automated test transmission from the <strong>MyLMS Communication Gateway</strong>.</p>
                        ...
                        <div style="margin: 40px 0; padding: 20px; background: #f8fafc; border-radius: 8px; border-left: 4px solid #5b21b6;">
                            ...
                            <p style="margin: 5px 0; font-size: 14px;"><strong>System:</strong> MyLMS Core Infrastructure</p>
                        </div>
                        <p>You can now proceed with automated admissions and invoice notifications.</p>
                    </div>
                    <div style="background: #f1f5f9; padding: 20px; text-align: center; font-size: 12px; color: #64748b;">
                        &copy; ' . now()->year . ' MyLMS Platform. All institutional systems operational.
                    </div>
                </div>
            ',
        );
