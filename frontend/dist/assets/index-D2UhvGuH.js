...
`,tk=t=>{let e=t.hotKeys?`${t.hotKeys}`:"";return th(t.streamType)==="live"&&(e+=" noarrowleft noarrowright"),e},ik={TOP:"top",CENTER:"center",BOTTOM:"bottom",LAYER:"layer",MEDIA_LAYER:"media-layer",POSTER_LAYER:"poster-layer",VERTICAL_LAYER:"vertical-layer",CENTERED_LAYER:"centered-layer",GESTURE_LAYER:"gesture-layer",CONTROLLER_LAYER:"controller",BUTTON:"button",RANGE:"range",THUMB:"thumb",DISPLAY:"display",CONTROL_BAR:"control-bar",MENU_BUTTON:"menu-button",MENU:"menu",MENU_ITEM:"menu-item",OPTION:"option",POSTER:"poster",LIVE:"live",PLAY:"play",PRE_PLAY:"pre-play",SEEK_BACKWARD:"seek-backward",SEEK_FORWARD:"seek-forward",MUTE:"mute",CAPTIONS:"captions",AIRPLAY:"airplay",PIP:"pip",FULLSCREEN:"fullscreen",CAST:"cast",PLAYBACK_RATE:"playback-rate",VOLUME:"volume",TIME:"time",TITLE:"title",AUDIO_TRACK:"audio-track",RENDITION:"rendition"},ak=Object.values(ik).join(", "),rk=t=>{var e,i,a,r,n,s,o,l,c,p,m,u,d,v,f,b,E,T,_,w,R,x,U,K,Q,W,H,He,et,tt,be,Ke,$t,Ve,yt,it,Ce,Be,qe,oi,ji;return Ro`
  ...
  >
    <mux-video
      ...
      stream-type="${(b=th(t.streamType))!=null?b:!1}"
